...
ui <- shiny::fluidPage(
    ...
    div(
        ...
        p(
            ...
            a(href = "https://www.business-science.io/", target = "blank", "Expert Shiny Application Develop Course"), 
            "by Business Science"
        ),
        ...
        fluidRow(
            ...
            column(
                ...
                tags$blockquote(
                    ...
                    p("When learnng data science consistency is more important than quantity"), 
                    tags$footer("Quoter by", tags$cite(title = "Matt Dancho", "Matt Dancho"))
                )
            )
        ),
...
# SERVER ----
div(class = "container-fluid", title = "Bootstrap Cheat Sheet for Shiny", "Hello, world")
